  ...
  projects: {
    ...
    items: [
      ...
      },
      {
        ...
        solution:
          "Ecommerce integrado ao Mercado Pago com reserva temporária de rifas: seleção de quantidade, bloqueio automático por 10 minutos e prazo de 15 minutos para pagamento.",
        impact:
