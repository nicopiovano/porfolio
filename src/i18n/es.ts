...
export default {
  ...
  hero: {
    headline: "Tenés un proyecto. Yo lo convierto en producto.",
    subheadline:
      "7 años de experiencia end-to-end. Trabajo con startups, empresas y comercios que quieren crecer online.",
  ...
  projects: {
    ...
    items: [
      ...
      {
        title: "Portfolio Profesional Multiidioma con IA",
        problem:
      ...
      {
        title: "ChatBox con IA",
        problem:
          "Usuarios con intención de compra sin respuesta inmediata generan fricción y pérdida de oportunidades.",
        solution:
          "Chat 24/7 con IA entrenada en el negocio, respuestas guiadas y flujos orientados a calificar leads y empujar a la acción.",
        impact:
          "Conversaciones más relevantes, mejor pre-calificación de contactos y mayor conversión a ventas.",
      },
    ],
  },
  experience: {
    ...
    items: [
      {
        ...
        description:
          "Sistemas críticos para múltiples organizaciones, foco en estabilidad, entregas incrementales y mejoras continuas.",
        aprendizajes:
          "Claridad de alcance, entregas iterativas y reducción de riesgos en producción.",
      },
      {
        ...
        description:
          "Evolución de producto y features con foco en performance, UX y mantenibilidad.",
      ...
      },
      {
        ...
        description:
          "E-commerce internacional con estándares, deadlines y comunicación en inglés.",
        aprendizajes:
          "Entrega bajo presión con calidad y alineación constante.",
      },
      {
        ...
        description:
          "Sistemas con alta demanda y datos sensibles: foco en calidad, seguridad y performance.",
  ...
  seo: {
    title:
      "Porfolio de Nico Piovano - Desarrollador Web con +7 años de experiencia",
    description:
      "Contrata a Nico para crear tu aplicación web o móvil. Desarrollador Web.",
  },
  chat: {
  ...
  modeSelector: {
    ...
    subtitle:
      "Elegí una opción para ver la versión del porfolio más relevante.",
      ...
      items: [
        {
          ...
          description:
            "Autenticación basada en cookies con Laravel Sanctum para mayor seguridad, evitando tokens en localStorage. Frontend SPA consume la API con Axios configurado automáticamente. Rutas protegidas gestionadas con ProtectedRoute.",
        },
        {
          title: "Market Dashboard",
          description:
            "Dashboard financiero con datos mockeados para simular información de mercado. Sistema de visualización con gráficos interactivos y métricas clave.",
        },
        {
          title: "Tech Decision Simulator",
          description:
            "Simulador que utiliza un motor de decisiones (decisionEngine) para evaluar y recomendar tecnologías. Analiza disponibilidad, complejidad y requisitos del proyecto, generando recomendaciones basadas en reglas programadas.",
        },
        {
          title: "Gran Rifa",
          description:
            "App de rifas 100% frontend: carrusel de premios, grilla de números (1–1000) para elegir, carrito flotante y modal de checkout con formulario. React, Vite, Motion, Tailwind y Radix UI. Formato de precios Argentina ($1.000).",
        },
        {
          title: "Porfolio Multiidioma",
          description:
            "Porfolio con soporte multiidioma (ES, EN, PT) usando i18n personalizado. Rutas por idioma (/es, /en, /pt) para SEO, traducciones centralizadas y detección automática desde la URL.",
        },
        {
          title: "Chat Programable",
          description:
            "Chat asistente con respuestas programables basadas en intents. Matcher detecta la intención del usuario y devuelve respuestas contextuales con follow-ups dinámicos. Funciona completamente en el cliente sin backend.",
        },
      ],
    },
    experience: {
      ...
      items: [
        {
          ...
          usos: ["Vue", "Laravel", "Docker", "MySQL"],
          description:
            "Desarrollo de sistemas informáticos para las distintas Municipalidades de la República Argentina.",
          aprendizajes:
            "Perfeccionamiento de tecnologías frontend. Reutilización de componentes y estados de Vue. Mejora en el uso de Docker.",
        },
        {
          date: "Jun. 2021 - Abr. 2023",
          title: "Desarrollador Web Fullstack",
          ...
          description:
            "Desarrollo de sistemas informáticos para las distintas Municipalidades de la República Argentina.",
          aprendizajes:
            "Desarrollo personal y laboral en frontend. Manejo de estados y hooks de React. Desarrollo de test unitarios.",
        },
        {
          date: "Nov. 2020 - May. 2021",
          title: "Desarrollador Web Backend",
          ...
          aprendizajes:
            "Manejo de CMS, comunicación directa con clientes de Estados Unidos mediante dailies en inglés.",
        },
        {
          date: "Dic. 2018 - Nov. 2020",
          title: "Desarrollador Web Fullstack",
          ...
          usos: ["Symfony", "AngularJS", "Angular", "MySQL"],
          description:
            "Mantenimiento y desarrollo de sistemas internos y externos para transportes públicos de corta y larga distancia.",
          aprendizajes:
            "Inicio como Trainee. Lenguaje puro a Frameworks. Sólida base en seguridad, arquitectura de datos y optimización de consultas SQL.",
        },
      ],
    },
    aboutMe: {
