...
export const RESPONSES_EN: Record<string, ChatResponse> = {
  ...
  projects: {
    text:
      "I've worked on various projects: management systems, e-commerce, administrative dashboards and complex web applications. Some projects are in my porfolio.",
    followUps: [
  ...
  "projects.show": {
    text:
      "You can see some of my projects in the projects section of my porfolio. They include management systems, e-commerce and complex web applications.",
    followUps: [
      "What type of systems have you developed?",
      "Have you worked on e-commerce?",
      "⬅ Back to start"
  ...
  ai: {
    text: "I use it quite a bit, side by side. Mainly to accelerate development: code generation, refactoring, debugging, and documentation. I also use it to explore new technologies and find solutions to complex problems. It's another tool in my stack that helps me be more productive and efficient.",
    followUps: [
      "⬅ Back to start"
    ]
  },
